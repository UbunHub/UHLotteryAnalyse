...
-(void)getHttpData{
    ...
    [httpInterFace getRecommendCodeWithBeginOutNO:@"2016000" EndOutNO:@"2016223" Probability:_probability RecommendOutON:_recommendOutON];
}
...
//    _geOutCode_lab.text = [[dataDic objectForKey:@"outData"] objectForKey:@"out_ge"];
...
//    _shiOutCode_lab.text = [[dataDic objectForKey:@"outData"] objectForKey:@"out_shi"];
...
//    _baiOutCode_lab.text =[[dataDic objectForKey:@"outData"] objectForKey:@"out_bai"];
